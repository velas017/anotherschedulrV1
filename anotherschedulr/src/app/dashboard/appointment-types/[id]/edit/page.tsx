    ...
    try {
      ...
      if (serviceResponse.ok) {
        ...
        setFormData({
          ...
          messageAfterScheduling: '',
          blockTimeBefore: false,
          blockTimeAfter: service.paddingTime ? true : false,
          blockTimeBeforeMinutes: 0,
          blockTimeAfterMinutes: service.paddingTime || 0,
          color: '#8B5CF6',
          isVisible: service.isVisible,
          isPrivate: service.isPrivate || false
        });
        
        if (service.paddingTime && service.paddingTime > 0) {
          setShowBlockTimeOptions(true);
        }
      }
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-xl font-semibold text-gray-900">Edit appointment type</h1>
